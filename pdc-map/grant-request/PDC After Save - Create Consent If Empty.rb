...
if !model.grant_begins_at.blank? && model.grant_begins_at.year >= 2025 && !model.program_organization.blank? && model.dyn_invoke_for(:"PDC Safe Consent Form Lookup").blank?
